---
title: "The Energy Landscape and Renewable Transition"
author: "Fox Redmond"
date: "`r Sys.Date()`"
...
ggplot(carbi,
       aes(x = year,
           ...
           color = country)) +
  geom_point() +
  scale_y_continuous(trans = "log", breaks = c(2, 150, 8000)) +
  theme_bw() +
...
ggplot(carbi2, 
       aes(x = year,
           ...
           color = country)) +
  geom_point() +
  scale_y_continuous(trans = "log", breaks = c(20, 150, 1000, 8000)) +
  theme_bw() +
